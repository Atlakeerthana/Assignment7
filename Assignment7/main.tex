...
\end{align}
 ...
 \begin{align}
 \vec{(PA)}^2&=\norm{\vec P-\vec A}^2\\
 &=\norm{\vec P}^2+\norm{\vec A}^2-2\vec P^T\vec A\\
 &=\norm{\myvec{X\\Y\\Z}}^2+ \norm{\myvec{3\\4\\5}}^2-2\myvec{3 \\ 4 \\ 5}\myvec{X & Y & Z}\\
 &=X^2+Y^2+Z^2-6X-8Y-10Z+50
 \end{align}
 and
 \begin{align}
 \vec{(PB)}^2&=\norm{\vec P-\vec B}^2\\
&=\norm{\vec P}^2+\norm{\vec B}^2-2\vec P^T\vec B\\
 &=\norm{\myvec{X\\Y\\Z}}^2+ \norm{\myvec{-1\\3\\-7}}^2-2\myvec{-1 \\ 3 \\ -7}\myvec{X & Y & Z}\\
...
\begin{align}
 \vec{(PA)}^2+ \vec{(PB)}^2 =2k^2
 \end{align}
 Sub (2.0.7) and (2.0.11) values in (2.0.12)\\
